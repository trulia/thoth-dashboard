var thothApi = {
  ...
  getUri: function (params) {
    var urlParams = [params.objectId, (params.server == undefined)? params.pool : params.server , 'core', params.core, 'port', params.port, 'start', params.from_date, 'end', params.to_date, params.attribute, params.endpoint];
